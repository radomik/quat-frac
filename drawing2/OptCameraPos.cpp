...
void OptCameraPos::readJson(const nlohmann::json &json, const char *tag) {
...
nlohmann::json OptCameraPos::saveJson(const char *tag) const {
...
void OptCameraPos::readBin(FILE *file, const char *tag) {
...
void OptCameraPos::saveBin(FILE *file, const char *tag) const {
