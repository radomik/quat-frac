...
int OptAppDrawingParser::readText(Parser& parser) {
...
int OptAppDrawingParser::saveText(Parser& parser) const {
	assert(m_opt_app_drawing_save != NULL);
	return parser.writeObject(*m_opt_app_drawing_save, Name::opt_app_drawing);
}

int OptAppDrawingParser::readBin(FILE* f) {
	return opt_app_drawing.readBin(f);
}

int OptAppDrawingParser::saveBin(FILE* f) const {
	assert(m_opt_app_drawing_save != NULL);
