...
void OptAppDrawing::readJson(const nlohmann::json &json, const char *tag) {
...
nlohmann::json OptAppDrawing::saveJson(const char *tag) const {
  // write: opt_camera
...
void OptAppDrawing::readBin(FILE *file, const char *tag) {
...
void OptAppDrawing::saveBin(FILE *file, const char *tag) const {
