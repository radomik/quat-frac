...
int OptCameraTransSpeed::readText(Parser& parser) {
...
int OptCameraZoomSpeed::readText(Parser& parser) {
...
int OptCameraRotate::readText(Parser& parser) {
...
int OptCamera::readText(Parser& parser) {
...
int OptCameraTransSpeed::saveText(Parser& parser) const {
	Float val_float;
...
int OptCameraZoomSpeed::saveText(Parser& parser) const {
	Float val_float;
...
int OptCameraRotate::saveText(Parser& parser) const {
	Float	val_float;
	YesNo	o_enabled_mouse_rotate;
...
int OptCamera::saveText(Parser& parser) const {
...
int OptCameraRotate::saveBin(FILE* f) const {
...
int OptCamera::saveBin(FILE* f) const {
